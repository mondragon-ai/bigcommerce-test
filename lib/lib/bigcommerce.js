...
exports.addShippingToCustomer = exports.addBillingToCheckout = exports.cartToCheckout = exports.createBigCommerceCart = exports.createBigCommerceCustomer = void 0;
 ...
 */
async function createBigCommerceCustomer(data) {
...
exports.createBigCommerceCustomer = createBigCommerceCustomer;
;
/**
 ...
 */
async function createBigCommerceCart(body) {
    // Check the status of the Shopify Create Customer Call
    async function checkStatus(r) {
        const data = await r.json();
        // If 200 >= x < 300, & return customer ID
...
exports.createBigCommerceCart = createBigCommerceCart;
;
/**
 *  Create Cart WITH product
 ...
 *  @returns String for BC_Cart
 */
async function cartToCheckout(checkoutId) {
    // Check the status of the Shopify Create Customer Call
    async function checkStatus(r) {
        const data = await r.json();
        // If 200 >= x < 300, & return customer ID
...
exports.cartToCheckout = cartToCheckout;
;
async function addBillingToCheckout(checkoutId, body) {
    // Check the status of the Shopify Create Customer Call
    async function checkStatus(r) {
        const data = await r.json();
        // If 200 >= x < 300, & return customer ID
...
exports.addBillingToCheckout = addBillingToCheckout;
;
async function addShippingToCustomer(body) {
    // Check the status of the Shopify Create Customer Call
    async function checkStatus(r) {
        const data = await r.json();
        // If 200 >= x < 300, & return customer ID
...
exports.addShippingToCustomer = addShippingToCustomer;
;
// TODO: Add to Product
